  ...
  <div class="wrapper theme-1-active pimary-color-green">
    ...
    <div class="fixed-sidebar-left">
      <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
          <a href="<?= site_url('Siswa') ?>"><div class="pull-left"><i class="zmdi zmdi-face mr-20"></i><span class="right-nav-text">Siswa</span></div><div class="clearfix"></div></a>
        </li>
        <li>
          <a href="<?= site_url('Guru') ?>"><div class="pull-left"><i class="zmdi zmdi-account mr-20"></i><span class="right-nav-text">Guru</span></div><div class="clearfix"></div></a>
        </li>
        <li>
          <a href="<?= site_url('Mapel') ?>"><div class="pull-left"><i class="zmdi zmdi-book mr-20"></i><span class="right-nav-text">Mapel</span></div><div class="clearfix"></div></a>
        </li>
